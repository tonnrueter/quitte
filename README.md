...
R package **quitte**, version **0.3147.0**
...
Pehl M, Bauer N, Hilaire J, Levesque A, Luderer G, Schultes A, Dietrich J, Richters O, Rüter T (2026). "quitte: Bits and pieces of code to use with quitte-style data frames." Version: 0.3147.0, <https://github.com/pik-piam/quitte>.
